...
- [x] **Replay scrubber UI** -- Timeline bar at viewport bottom, play/pause/seek through event history
...
- [x] **Fog of war shader** -- Tile opacity decays based on time since last agent report
...
- [x] **Emergent spatial drift** -- Agents that collaborate frequently drift closer on the map
...
- [x] **Day/night real-time lighting cycle** -- Directional light angle + color temperature tied to wall clock
...
- [x] **Weather skybox** -- Gradient skybox interpolates between sunny/overcast/storm based on project health
...
- [x] **Ambient audio system** -- Office noise scales with busyness, alert tones for errors
...
- [x] **Building upgrade tiers** -- tent -> shed -> office -> modern -> glass tower per team productivity
...
- [x] **Screenshot mode** -- Chrome-free export with vignette post-processing
...
- [x] **Minimap** -- 120x120px bottom-left, shows viewport rectangle + agent dots
